...
/**
 * The deluxe room class, contains methods for deluxe room in motel.
 * @author Vy Nguyen and Nicki Huynh
 * @date 12/09/2019
 */
public class DeluxeRoom implements MotelRoom {
	...
	/**
	 * Constructor of the DeluxeRoom class.
